...
(function (tss) {
    var TypeScriptSimple = (function () {
        ...
        TypeScriptSimple.prototype.getEmulatedEmitHost = function (service) {
        ...
        TypeScriptSimple.prototype.getSourceFilePathInNewDir = function (service, fileName) {
            var outputFileName;
        ...
        TypeScriptSimple.prototype.toJavaScript = function (service, fileName) {
            ...
            var outputFileName = this.getSourceFilePathInNewDir(service, fileName);
            // for Windows #37
